...
val prodicts= listOf<Product>(
   ...
   Product(5,0,"Джинсы 6","Синий",2000.0f,"56dgsder","На любой сезон", listOf("L","M","XL"),listOf("file:///android_asset/Jeans/j6.png")),
   Product(6,2,"Платье 1001","Синий",2000.0f,"56xdgsdgeter","На любой сезон",listOf("L","M","XL"), listOf("file:///android_asset/dress/d1.png")),
   Product(7,2,"Платье 1002","Синий",2000.0f,"56xdgsdgeter","На любой сезон", listOf("L","M","XL"),listOf("file:///android_asset/dress/d2.png")),
   Product(8,2,"Платье 1003","Синий",2000.0f,"56xdgsdgeter","На любой сезон",listOf("L","M","XL"), listOf("file:///android_asset/dress/d3.png")),
   Product(10,2,"Платье 1005","Синий",2000.0f,"56xdgsdgeter","На любой сезон",listOf("L","M","XL"), listOf("file:///android_asset/dress/d5.png")),
   Product(11,2,"Платье 1006","Синий",2000.0f,"56xdgsdgeter","На любой сезон",listOf("L","M","XL"), listOf("file:///android_asset/dress/d6.png")),
   Product(12,2,"Платье 1007","Синий",2000.0f,"56xdgsdgeter","На любой сезон",listOf("L","M","XL"), listOf("file:///android_asset/dress/d7.png")),
